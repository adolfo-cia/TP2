    ...
    public partial class subirNotas : System.Web.UI.Page
    {
        ...
        private void CargarGridDocenteCurso()
        {
            try
            {
                ...
                {
                    ID = docur.ID,
                    MAteria = (LogicMateria.GetOne((LogicCurso.GetOne(docur.IDCurso).IDMateria))).Descripcion,
                    COmision = (LogicComision.GetOne((LogicCurso.GetOne(docur.IDCurso).IDComision))).Descripcion,
        ...
        private void CargargridInscripcionesCurso()
        {
            try
            {
                ...
                var inscripciones = InscripcionLogic.GetAll(DocenteCursoLogic.GetOne(SelectedID.Value).IDCurso);
                ...
                {         
                     ID = ins.ID,
                      ALumno = PersonaLogic.GetOneByID(ins.IDAlumno).Apellido      
                } );
