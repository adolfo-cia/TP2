<%@ Page Title="Usuarios" Language="C#" MasterPageFile ="~/Site.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" StyleSheetTheme="GridViewTheme" Inherits="UI_Web.Usuarios" %>
...
<asp:Panel ID="serializarPanel" runat="server" Enabled="false" Visible="false">
